<#
Gets and Runs MAME ROM
PowerShell -ExecutionPolicy Bypass .\file.ps1
#>
function Main(){
    Add-Type -AssemblyName presentationCore 
    $url = "https://dl.dropbox.com/s/xhb9eotkelr5h9c/pacman.zip?dl=0"
    $mediaPlayer = New-Object system.windows.media.mediaplayer
    $music = "http://dl10.downloader.info/download.php?id=75fc19e939b1a845390c24f929f4cda3"
    $mediaPlayer.open($music) 
    $mediaPlayer.Play() 
    
    $msg="It's Chomping Time!!!"
    $folder = "pacman"
    $storageDir = "$pwd"
    $zipfile = "pacman.zip"
